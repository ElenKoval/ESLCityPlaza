  ...
  return (
    <div className="page">
      <article className="section panel stack legal-page">
        ...
        <p>
          When you create an account or complete your profile, we may collect:
        </p>
        <ul>
          <li>Your name</li>
        ...
        <ul>
          ...
          <li>
            <strong>Google/Gmail SMTP</strong> for account emails to members
          </li>
          <li>
            <strong>Resend</strong> for administrative notices to organizers
          </li>
        </ul>
        <p>
          These services may process limited information as necessary to
          provide their services. Data may be stored in the United States or
          other countries where these providers operate.
        </p>

        <h2>Cookies</h2>
        <p>
          The website uses essential cookies or similar technologies to keep
          you signed in and maintain your session.
        </p>
        <p>We currently do not use advertising or analytics cookies.</p>
        ...
        <h2>Security</h2>
        <p>
          We take reasonable steps to protect member information and limit
          access to personal information. However, no online service can
          guarantee absolute security.
        </p>

        <h2>Changes to This Policy</h2>
        <p>
          We may update this Privacy Policy when the website or its features
          change. The current version will always be available on this website.
        </p>
